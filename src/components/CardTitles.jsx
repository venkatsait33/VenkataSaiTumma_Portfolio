...
const CardTitles = () => {
    ...
    <div className="flex flex-col items-center justify-center p-20 mx-auto mt-20 ">
      <div className="flex flex-wrap gap-2 ">
        ...
        <div className="flex flex-col gap-2">
          <div className=" bg-[#e5e3e3] p-4 rounded-xl h-[200px] sw-[400px]">
            ...
            <div className="flex gap-2 m-4 text-[40px] justify-between items-center p-2">
              <CiLocationOn />
              <CiLocationOn />
              <FaLocationDot className="font-semibold text-blue-600" />
              <CiLocationOn />
              <CiLocationOn />
            </div>
          </div>

          <div className="bg-[#e5e3e3] p-2 rounded-xl h-[290px] w-[400px]">
            <span className="mb-4 ml-2 text-2xl font-semibold">Coding</span>
  ...
  <body>
      ...
      <div className="flex flex-wrap gap-2 mt-2">
        <div className=" bg-[#e5e3e3] p-4 rounded-xl h-[200px] w-[300px]">
          <div className="flex flex-col justify-between h-full">
            <p className="badge badge-lg ">
              <span className="w-2 h-2 bg-blue-500 rounded-full animate-blink"></span>
              <span className="p-2 text-xl ">What i do</span>
            </p>
        ...
        <div className=" bg-[#e5e3e3] p-4 rounded-xl w-full md:h-[200px] md:w-[500px]">
          <div className="flex flex-col justify-between h-full">
            <p className="badge badge-lg ">
              <span className="w-2 h-2 bg-blue-500 rounded-full animate-blink"></span>
              <span className="p-2 text-xl ">What i do</span>
